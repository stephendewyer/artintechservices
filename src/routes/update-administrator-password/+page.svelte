<script lang="ts">
    ...
    const updatePassword = async (
        ...
        const response = await fetch("/api/authentication/updatePassword/updatePasswordAdministrator", {
            method: "PATCH",
            body: JSON.stringify({
                password,
                passwordReentered,
...
<svelte:head>
    <title>Art in Tech Services - update administrator password</title>
    <meta name="description" content="update administrator password" />
...
<div class="page">
    ...
    <div class="login_helpers_column">
        <h4 class="login_helper_prompt">
            did not receive password update link?
        </h4>
        <a href="/reset-administrator-password">
            <ActionButtonSecondary>
                resend password update link
            </ActionButtonSecondary>
        </a>
    </div>
    <a href="/reset-administrator-password" class="cancel_button_container">
        <CancelButton>
            cancel
        </CancelButton>
    </a>
